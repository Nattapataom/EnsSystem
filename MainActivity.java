...
public class MainActivity extends AppCompatActivity {
    ...
    private void synJSONtoSQLite() {
        ...
        while (intTABLE <= 3) {
            ...
            String strURLuser = "enssystem/php_get_user_master.php";
            String strURLnews = "enssystem/php_get_news_master.php";
            String strURLcall = "enssystem/ens/php_get_call.php";
